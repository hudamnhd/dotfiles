...
static const int systraypinningfailfirst =
    0; /* 1: if pinning fails, display systray on the first monitor, False:
          display systray on the last monitor*/
static const int showsystray = 1; /* 0 means no systray */
static const int showbar = 1;     /* 0 means no bar */
static const int topbar = 0;      /* 0 means bottom bar */
static const char *fonts[] = {"Iosevka Medium"
                              ":pixelsize=14:antialias=true:autohint=true"};
...
static char col_light_blue[] = "#536DFE";
...
#define TAGKEYS(KEY, TAG)                                                      \
    {MODKEY, KEY, view, {.ui = 1 << TAG}},                                     \
        {MODKEY | ShiftMask, KEY, followtag, {.ui = 1 << TAG}},                            \
        {MODKEY | ShiftMask | Mod1Mask, KEY, tag, {.ui = 1 << TAG}},                       \
...
static const char *instantshutdowncmd[] = {"rofi",
                                           "-show",
                                           "p",
                                           "-modi",
                                           "p:rofi-power-menu",
                                           ...
                                           "MousePrimary",
                                           NULL};
static const char *instantswitchcmd[] = {"/home/hudamnhd/.local/bin/rofi-window",
                                         NULL};
static const char *startmenucmd[] = {"/home/hudamnhd/.local/bin/rofi-custom", NULL};
static const char *ranger[] = {"/home/hudamnhd/.local/bin/rgr", NULL};
...
static const char *caretinstantswitchcmd[] = {"rofi",
                                              "-show",
                                              "run",
                                              "-show-icons",
                                              "Alt+Tab,Down",
...
static Key dkeys[] = {
    ...
    {0, XK_a, spawn, SHCMD("qutebrowser")},
...
static Key keys[] = {
    ...
    // {MODKEY, XK_e, fullovertoggle, {.ui = ~0}},
    // {MODKEY, XK_d, distributeclients, {0}},
    ...
    {MODKEY, XK_grave,unhideall,{0}},
    {MODKEY, XK_Tab, lastview,{0}},
    {MODKEY, XK_q, spawn, {.v = startmenucmd}},
...
static Button buttons[] = {
    ...
    {ClkTagBar, ALTKEY, Button1, followtag, {0}},
