...
#if PANGO_PATCH
static char font[] = "IosevkaTree Nerd Font:style=SemiBold:pixelsize=14:antialias=true:autohint=true";
#else
#if XRESOURCES_PATCH
static char *fonts[] =
#else
...
{
	"IosevkaTree Nerd Font:style=SemiBold:pixelsize=14:antialias=true:autohint=true"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
