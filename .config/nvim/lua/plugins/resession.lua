...
return {
  ...
  config = function(_, opts)
    ...
    local aug = vim.api.nvim_create_augroup("Resession", {})
    ...
    -- vim.keymap.set("n", "<leader>sl", function() resession.load(nil, { reset = false }) end, { desc = "[S]ession [L]oad without reset" })
    ...
    vim.keymap.set("n", "ZZ", function()
      ...
      vim.api.nvim_create_augroup("Resession", {})
      vim.cmd("qa")
    end)
        -- stylua: ignore end
