...
local function mappings(event)
  ...
  -- show hidden
  map("n", "gh", [[:silent keeppatterns g@\v/\.[^\/]+/?$@d _<cr>:setl cole=3<cr>]])
...
return {
  ...
  { "hudamnhd/vim-dirvish", enabled = false, event = { "VeryLazy" } },
}
