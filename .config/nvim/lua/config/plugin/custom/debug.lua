...
M.formatters = {
  ...
  typescript = function(...) return M.formatters.javascript(...) end,
  javascriptreact = function(...) return M.formatters.javascript(...) end,
  typescriptreact = function(...) return M.formatters.javascript(...) end,
