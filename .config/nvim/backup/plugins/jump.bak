...
function Plugin.init()
  -- vim.keymap.set({'n', 'x', 'o'}, 'gH', 'ak')
  -- vim.keymap.set({'n', 'x', 'o'}, 'gL', 'aj')
end
...
function Plugin.keys()
  ...
  bind("f", user.jump_word(), "Jump to word")
  bind("F", user.jump_char(), "Two characters search")

  -- bind('ak', user.jump_line('up'), 'Jump to line above cursor')
  -- bind('aj', user.jump_line('down'), 'Jump to line below cursor')
