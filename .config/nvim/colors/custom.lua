...
local enable_colorscheme = function()
  ...
  hi('LineflyNormal',  { fg=bg.grey2, bg=fg.cyan })
  hi('LineflyInsert',  { fg=bg.grey2, bg=fg.blue })
  hi('LineflyVisual',  { fg=bg.grey2, bg=fg.magenta })
  hi('LineflyReplace', { fg=bg.grey2, bg=fg.yellow })
  hi('LineflyCommand', { fg=bg.grey2, bg=fg.red })
