...
local function load_solarized()
  ...
  shl("StatusLine", { bg = colors.base01, fg = colors.base02 })
  shl("StatusLineNC", { bg = colors.base01, fg = colors.base02 })
  ...
  shl("LineflyNormal", { bg = colors.blue, fg = "black" })
  shl("LineflyInsert", { bg = colors.green, fg = "black" })
  shl("LineflyVisual", { bg = colors.magenta, fg = "black" })
  shl("LineflyReplace", { bg = colors.yellow, fg = "black" })
  shl("LineflyCommand", { bg = colors.orange, fg = "black" })
end
