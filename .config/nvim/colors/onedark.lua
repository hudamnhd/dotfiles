...
local green = 0xa3e635
local yellow = 0xfde047
-- local orange = 0xf472b6
local orange = 0xfda4af
local blue = 0x93c5fd
local purple = 0xf0abfc
local cyan = 0xa5b4fc
local white = 0xd1d5db
local black = 0x1f2937
local dim = 0x21252C
local visual_black = "NONE"
local light_grey = 0x848b98
local comment_grey = 0x9ca3af
local gutter_fg_grey = 0x6b7280
local cursor_grey = 0x374151
local float_grey = 0x1f2937
-- local visual_grey = 0x374151
local visual_grey = 0x4b5563
local menu_grey = 0x1f2937
local special_grey = 0x1f2937
