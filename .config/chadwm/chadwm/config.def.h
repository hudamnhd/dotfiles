...
static const char *fonts[]          = {"JetBrains Mono:style=Bold:size=10", "JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const char *power[] = { "rofi", "-show", "p", "-modi", "p:~/.local/bin/rofi-power-menu", "-me-select-entry", "", "-me-accept-entry", "MousePrimary",  NULL };
...
void togglelayout(const Arg *arg) {
    if (current_layout == 0)
        setlayout(&(const Arg){.v = &layouts[1]});
    else
...
static const Button buttons[] = {
    ...
    { ClkStatusText,        0,              Button3,        spawn,          {.v = pavu } },
    ...
    */
    ...
    { ClkClientWin,         ALTKEY,         Button1,        dragmfact,      {0} },
    { ClkClientWin,         ALTKEY,         Button3,        dragcfact,      {0} },
