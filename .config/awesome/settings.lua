...
settings.enableTitlebar = true -- Set to true if you wish to have title bars on top of applications (i.e to have buttons: close, minimise, etc )
...
settings.useNMApplet = false -- If you have network manager installed, you can use manage your network (i.e connect to wifi) from the system tray icon
