...
nmap('m', 'scroll-page 0 0.2')
nmap(',', 'scroll-page 0 -0.2')
nmap('N', 'tab-prev')
# no default binding
nmap('E', 'tab-next')
...
nunmap("'")
# real quickmarks
nmap("'11", ':open --tab localhost:3000')
nmap("'12", ':open --tab 127.0.0.1:8000')
...
nmap("zd", 'spawn --userscript dmenu_qutebrowser')
nmap("zj", 'spawn --userscript open_download')
nmap("zz", 'spawn --userscript qute-pass')
nmap("zx", 'spawn --userscript qute-pass -w')
