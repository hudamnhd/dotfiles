...
#if AUTOSTART_PATCH //============================================================================================= DWM
static const char autostartblocksh[]     = "autostart_blocking.sh";
static const char autostartsh[]          = "autostart.sh";
static const char dwmdir[]               = "/home/hudamnhd/.dwm";
...
static char selbordercolor[]             = "#bbbbbb";// border window
...
static char hidnormfgcolor[]             = "#6F6F6F";
...
static const char *termcmd1[]  = { "lxterminal", NULL };
...
static const Key keys[] = {
	...
	{ MODKEYA,			XK_period,		spawn,                  {.v = termcmd1 } },	
	...
	#endif 
	#if SCRATCHPAD_ALT_1_PATCH // USE
	{ MODKEY,                       XK_z,      scratchpad_show,        {0} }, 
	{ MODKEYA,             		XK_z,      scratchpad_hide,        {0} },
	{ MODKEYA,                      XK_x,      scratchpad_remove,      {0} },
	...
	#if ALT_TAB_PATCH // No use
	{ Mod1Mask,                     XK_Tab,        alttabstart,            {0} },
	#else
	{ MODKEY,                       XK_Tab,        view,                   {0} },
	#endif // ALT_TAB_PATCH
	#if STACKER_PATCH // No use
	...
	#endif // FLEXTILE_DELUXE_LAYOUT huda configuration
