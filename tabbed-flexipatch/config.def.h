...
/* appearance */
static char *font         = {"IosevkaTree Nerd Font:style=Medium:pixelsize=14:antialias=true:autohint=true"};
static char *normbgcolor  = "#011627";
static char *normfgcolor  = "#7c8f8f";  
static char *selbgcolor   = "#011627";
static char *selfgcolor   = "#82aaff";
