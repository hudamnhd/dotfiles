...
local default_opts = {
  ...
  --     preview_border = hl_match({ "FloatBorder" }),
  ...
  previewers = {
    bat = {
      cmd = "bat",
      args = "--color=always --style=numbers,changes,grid,header-filename",
  ...
  actions = {
    files = {
      ...
      ["ctrl-l"] = fzf_lua.actions.file_edit_or_qf,
